    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid">
                <h1 class="mt-4">Historia de Usuario</h1>
...
<!--
                ...
                @endauth
-->
                <form class="form-horizontal text-left" role="form" method="POST" action="{{ url('/user/crear_historia/' ) }}">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group{{ $errors->has('responsable') ? ' has-error' : '' }}">
                        ...
                        <div class="">
                            <input id="responsable" type="string" class="form-control" name="responsable">
                    ...
                    <div class="form-group{{ $errors->has('tiempoest') ? ' has-error' : '' }}">
                        <label for="tiempoest" class="control-label">Tiempo estimado</label>

                        <div class="">
                            <input id="tiempoest" type="string" class="form-control" name="tiempoest">

                            @if ($errors->has('tiempoest'))
                                <span class="help-block">
                                        <strong>{{ $errors->first('tiempoest') }}</strong>
                                    </span>
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="form-group{{ $errors->has('prioridad') ? ' has-error' : '' }}">
                        ...
                        <div class="">
                            <input id="prioridad" type="string" class="form-control" name="prioridad">

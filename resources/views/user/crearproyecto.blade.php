    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid">
                ...
                <form class="form-horizontal text-left" role="form" method="POST" action="{{ url('/user/crear_proyecto/'.$clienteid ) }}">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group{{ $errors->has('estado') ? ' has-error' : '' }}">
                        <label for="estado" class="control-label">Estimacion(estado)</label>
